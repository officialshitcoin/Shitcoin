...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(27000000);
...
const uint64_t MAX_BLOCK_SIZE_GROWTH__NUMERATOR         = 100 * 1024;
...
const int      P2P_DEFAULT_PORT                              = 27000;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 27001;
